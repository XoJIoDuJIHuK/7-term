...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Prayer Times', style: TextStyle(color: Colors.black)),
        elevation: 0,
                      ...
                      Row(
                        ...
                        children: [
                          buildPrayerTimeCard(
                              ...
                              scale: scale,
                              backgroundColor: Color(0xFFE3DDFF),
                          ...
                          buildPrayerTimeCard(
                              ...
                              scale: scale,
                              backgroundColor: Color(0xFF36229F),
                      ...
                      Row(
                        ...
                        children: [
                          buildPrayerTimeCard(
                              ...
                              scale: scale,
                              backgroundColor: Color(0xFF826AFB),
                              titleColor: Colors.white,
                          ...
                          buildPrayerTimeCard(
                              ...
                              time: '6:45',
                              timePostfix: 'pm',
                              timeColor: Color(0xFFE8BD46),
                              iconColor: Colors.limeAccent,
                              scale: scale,
                              backgroundColor: Color(0xFFFDE9C2),
                              titleColor: Colors.black,
